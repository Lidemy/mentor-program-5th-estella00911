...
function init(options) {
  ...
  containerElement.append((0,_templates__WEBPACK_IMPORTED_MODULE_3__.getForm)(formClassName, commentsClassName))
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).on('click', '.' + loadMoreClassName, () => {
    getNewComments()
  })
  ...
  function getNewComments() {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_1__.getComments)((apiUrl, siteKey, lastId, data) => {
      if (!data.ok) {
        alert(data.message)
        return
      }
      ...
      const loadMoreBtnHTML = (0,_templates__WEBPACK_IMPORTED_MODULE_3__.getLoadMoreButton)(loadMoreClassName)
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).append(loadMoreBtnHTML)
      if (length <= 5) {
        isEnd = true
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.' + loadMoreClassName).hide()
      }
