...
/* harmony export */   "loadMoreBtnHTML": () => (/* binding */ loadMoreBtnHTML),
/* harmony export */   "getForm": () => (/* binding */ getForm),
/* harmony export */   "getLoadMoreButton": () => (/* binding */ getLoadMoreButton)
/* harmony export */ });
const cssTemplate = '.card {word - wrap: break-word; white-space: pre-line;}'
...
function init(options) {
  ...
  function getNewComments() {
    const commentDOM = jquery__WEBPACK_IMPORTED_MODULE_3___default()(commentsSelector)
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_0__.getComments)((apiUrl, siteKey, lastId, data) => {
      ...
      const loadMoreBtnHTML = (0,_templates__WEBPACK_IMPORTED_MODULE_2__.getLoadMoreButton)(loadMoreClassName)
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(commentsSelector).append(loadMoreBtnHTML)
      if (length <= 5) {
        isEnd = true
        jquery__WEBPACK_IMPORTED_MODULE_3___default()('.' + loadMoreClassName).hide()
      }
